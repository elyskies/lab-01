...
visitors %>% head(n = 10)      #new line of code!!! it shows 10 rows of data!!
```
...
```{r Ex_h}
visitors %>% 
  #filter(n_2021 >= 0) %>% #I ADDED THIS LINE WHOOPS
  summarise(
...
**not applicable. cause its not in integer form **
